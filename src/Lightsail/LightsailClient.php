 ...
 * @phpstan-method \Aws\Result getProfile(array{...} $args = [])
 * @method \GuzzleHttp\Promise\Promise getProfileAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise getProfileAsync(array{...} $args = [])
 ...
 *     relationalDatabaseName?: string,
 *     metricName?: 'CPUUtilization'|'DatabaseConnections'|'DiskQueueDepth'|'FreeStorageSpace'|'FreeableMemory'|'NetworkReceiveThroughput'|'NetworkTransmitThroughput'|'SwapUsage',
 *     period?: int,
 *     startTime?: int|string|\DateTimeInterface,
 *     endTime?: int|string|\DateTimeInterface,
 *     unit?: 'Bits'|'Bits/Second'|'Bytes'|'Bytes/Second'|'Count'|'Count/Second'|'Gigabits'|'Gigabits/Second'|'Gigabytes'|'Gigabytes/Second'|'Kilobits'|'Kilobits/Second'|'Kilobytes'|'Kilobytes/Second'|'Megabits'|'Megabits/Second'|'Megabytes'|'Megabytes/Second'|'Microseconds'|'Milliseconds'|'None'|'Percent'|'Seconds'|'Terabits'|'Terabits/Second'|'Terabytes'|'Terabytes/Second',
 ...
 *     alarmName?: string,
 *     metricName?: 'BurstCapacityPercentage'|'BurstCapacityTime'|'CPUUtilization'|'ClientTLSNegotiationErrorCount'|'DatabaseConnections'|'DiskQueueDepth'|'FreeStorageSpace'|'FreeableMemory'|'HTTPCode_Instance_2XX_Count'|'HTTPCode_Instance_3XX_Count'|'HTTPCode_Instance_4XX_Count'|'HTTPCode_Instance_5XX_Count'|'HTTPCode_LB_4XX_Count'|'HTTPCode_LB_5XX_Count'|'HealthyHostCount'|'InstanceResponseTime'|'NetworkIn'|'NetworkOut'|'NetworkReceiveThroughput'|'NetworkTransmitThroughput'|'RejectedConnectionCount'|'RequestCount'|'StatusCheckFailed'|'StatusCheckFailed_Instance'|'StatusCheckFailed_System'|'SwapUsage'|'UnhealthyHostCount',
